...
[ 'shortBeat', 'longBeat' ].forEach(function(funcName) {
  var list = funcName.replace(/Beat/, '');
...
Bebopt.prototype.longOpt = Bebopt.prototype.longBeat;
Bebopt.prototype.longOption = Bebopt.prototype.longBeat;
Bebopt.prototype.shortOpt = Bebopt.prototype.shortBeat;
Bebopt.prototype.shortOption = Bebopt.prototype.shortBeat;
...
Bebopt.prototype._parentOrChildUsage = function(opt) {
  ...
  if (typeof(opt.usage) !== 'string') {
    return this.__hasChildParent(
      opt,
      self,
      function() { return ''; },
      function() { return this._options[opt.child.index].usage; },
      function() { return this._options[opt.parent.index].usage; },
      function(cbs) { return cbs.parent.apply(this, []); });
  } else {
    return opt.usage;
  }
};
...
Bebopt.prototype.__hasChildParent = function(opt, context, noneCb, childCb, parentCb, bothCb) {
  var callbacks = {
    none: noneCb,
    child: childCb,
    parent: parentCb,
  ...
  if (opt.child === null) {
    if (opt.parent === null) {
      return noneCb.apply(context, [callbacks]);
    } else {
      return parentCb.apply(context, [callbacks]);
    }
  } else {
    if (opt.parent === null) {
      return childCb.apply(context, [callbacks]);
    } else {
      return bothCb.apply(context, [callbacks]);
    }
  }
};
